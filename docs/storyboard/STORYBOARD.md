# BirdNET-Pi Flutter Storyboard

This document provides a comprehensive visual overview of the BirdNET-Pi Flutter frontend.
...
![Recordings by Date](recordings_date.png)

#### By Species
Aggregated by species to easily find all recordings of a specific bird.
![Recordings by Species](recordings_species.png)
...
![Detection Detail Sheet](detail_sheet_mobile.png)
...
![Basic Settings](settings_basic.png)
...
![Advanced Settings](settings_advanced.png)
