...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get downloadAudioZip => 'Generar archivos ZIP de audio para eBird';
  ...
  String get shareLiveAudioStream =>
      'URL del flujo RTSP (dejar vacío para deshabilitar)';
  ...
  @override
  String get generateLdfcsStandard => 'LDFCS (Térmico Estándar)';
  ...
  @override
  String get speciesListTester => 'Probador de lista de especies';

  @override
  String get previewSpeciesList => 'Vista previa de la lista de especies';
  ...
  String get sfThreshHelpExtended =>
      'Este valor es utilizado por el modelo para limitar la lista de especies posibles que intentará detectar... Un umbral de 0.03 significa 3%...';

  @override
  String get sfThreshTesterHint =>
      'Si desea experimentar con este valor de umbral y ver qué especies entran en la lista, puede usar la herramienta de prueba a continuación.';

  @override
  String get sfThreshTesterLegacyHint =>
      'Hague clic en \"Actualizar configuración\" al final de la página para instalar el archivo de etiquetas, luego regrese aquí.';
  ...
  String get notificationVarsHelp =>
      'Puede usar las siguientes variables en el título y el cuerpo...';

  @override
  String get excludeSpeciesHelp =>
      'Excluir estas especies de las notificaciones.';

  @override
  String get includeSpeciesHelp =>
      'Notificar SOLO para estas especies (nombres comunes separados por comas).';

  @override
  String get serverUrl => 'URL del servidor';

  @override
  String get pleaseEnterUrl => 'Ingrese la URL del servidor';

  @override
  String get serverUnreachable =>
      'Servidor inalcanzable. Verifique la dirección.';

  @override
  String get welcomeToBirdNetPi => 'Bienvenido a BirdNET-Pi';

  @override
  String get enterServerUrlDescription =>
      'Para comenzar, ingrese la URL de su servidor BirdNET-Pi.';

  @override
  String get connect => 'Conectar';

  @override
  String get serverUpdatedSuccessfully => '¡Servidor actualizado con éxito!';
  ...
  String get selectSpeciesToViewTrends =>
      'Seleccione una especie para ver tendencias';

  @override
  String speciesDetailsError(String error) {
    return 'Error de detalles de la especie: $error';
  }
  ...
  String get ebirdExportDesc =>
      'Flujo guiado para enviar listas de verificación.';

  @override
  String get csvExport => 'Exportar a CSV';

  @override
  String get csvExportDesc => 'Datos brutos filtrados por fecha y especie.';

  @override
  String get audioZipExport => 'Exportación de audio diaria';

  @override
  String get audioZipExportDesc => 'Solicite un zip de todas las grabaciones.';

  @override
  String get zipManager => 'Gestor de archivos ZIP';

  @override
  String get zipManagerDesc =>
      'Descargar o eliminar archivos ZIP del servidor.';
  ...
  @override
  String get filterBySpeciesOptional => 'Filtrar por especie (opcional)';

  @override
  String get selectedSpecies => 'Especies seleccionadas';

  @override
  String get emptyIncludeAllSpecies =>
      '* Si está vacío: incluye todas las especies';

  @override
  String get executeExport => 'EJECUTAR EXPORTAR';

  @override
  String get chooseFullDayText =>
      'Elija el día para el que desea exportar grabaciones:';

  @override
  String get requestZipGeneration => 'SOLICITAR GENERACIÓN DE ZIP';

  @override
  String get zipGenerationWarning =>
      '* La operación puede tardar unos minutos. Puede descargar el zip desde la sección \"Administración de Zip\".';

  @override
  String get zipGenerationStarted =>
      'Generación de ZIP iniciada. Estará disponible en la sección Zip Manager.';

  @override
  String get refreshList => 'Actualizar lista';

  @override
  String get downloadZip => 'Descargar';

  @override
  String get filterSpecies => 'Filtrar especies';

  @override
  String get allSpeciesWillBeExported => 'Todas las especies serán exportadas.';
  ...
  String get hourlyDistributionDetections =>
      'Distribución horaria (detecciones)';

  @override
  String get dayNightWeatherProfile => 'Perfil día/noche (clima)';

  @override
  String get dailyDetections => 'Detecciones diarias';

  @override
  String get temperatureUnitLabel => 'Temperatura (°C)';

  @override
  String get windSpeedUnitLabel => 'Velocidad del viento (km/h)';

  @override
  String get densityMapSunInfo =>
      'Mapa de densidad (por horas/diario) con salida y puesta del sol';

  @override
  String get externalSheet => 'Hoja externa';

  @override
  String get totalAllTime => 'Total (siempre)';

  @override
  String get detectionsLabel => 'Detecciones';

  @override
  String get maxConfidenceLabel => 'Máxima confianza';

  @override
  String get averageConfidenceLabel => 'Confianza media';

  @override
  String get dayLegend => 'Día ☀️';

  @override
  String get nightLegend => 'Noche 🌙';
  ...
  @override
  String get loadingAudioLabel => 'Cargando audio...';

  @override
  String get errorLoadingAudioLabel => 'Error al cargar el audio';
  ...
  String get ebirdExportError =>
      'Se produjo un error al solicitar la generación del ZIP.';
  ...
  @override
  String get ldfcsStandardTitle => 'Espectrograma de larga duración (estándar)';

  @override
  String get ldfcsIndicesTitle =>
      'Espectrogramma de larga duración (índices acústicos)';

  @override
  String get ldfcsDescription => 'Visualización de las grabaciones de 24 horas';

  @override
  String get weeklyLdfcsStandard => 'LDFCS semanal (Estándar)';

  @override
  String get weeklyLdfcsIndices => 'LDFCS semanal (Índices acústicos)';

  @override
  String get monthlyLdfcsStandard => 'LDFCS mensual (estándar)';

  @override
  String get monthlyLdfcsIndices => 'LDFCS mensual (índices acústicos)';

  @override
  String get dailyInsightsTitle => 'Perspectivas diarias';

  @override
  String get weeklyInsightsTitle => 'Perspectivas semanales';

  @override
  String get monthlyInsightsTitle => 'Perspectivas mensuales';

  @override
  String get hourlyActivityTitle => 'Actividad horaria';

  @override
  String get speciesDiversityTitle => 'Diversidad de especies';
