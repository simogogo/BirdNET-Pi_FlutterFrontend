...
import '../screens/stats/trends_screen.dart';
    ...
    routes: [
      ShellRoute(
        ...
        builder: (context, state, child) {
          ...
          if (location == '/recordings') index = 1;
          if (location == '/charts') index = 2;
          if (location == '/top-species') index = 3;
        ...
        routes: [
            ...
            pageBuilder: (context, state) {
              ...
              return NoTransitionPage(
                child: RecordingsScreen(
                  initialTab: int.tryParse(params['tab'] ?? ''),
          ...
          GoRoute(
            path: '/top-species',
            builder: (context, state) => const TopSpeciesScreen(),
          ),
          GoRoute(
            path: '/analysis-log',
            pageBuilder: (context, state) =>
